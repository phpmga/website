...
<head>
    ...
    <meta name="google-site-verification" content="DbMCcMUJ8xPX65DfsCnDxlJBJEDI-xnPRAGCNqyGCe8"/>
            ...
            <div class="ui stackable inverted divided equal height grid">
                ...
                <div class="six wide column">
                    ...
                    <div class="ui inverted horizontal link list">
                        <a href="https://www.facebook.com/pages/PhpMga/492166247613145" class="item" target="_blank"
                           title="Facebook"><i class="big facebook icon"></i></a>
                        <a href="https://github.com/phpmga" class="item" target="_blank" title="Github"><i
                                    class="big github icon"></i></a>

                        <a href="/slack" target="_blank" class="item" title="Slack">
                ...
                <div class="four wide column">
                    ...
                    <br />
                    <div class="ui inverted horizontal">
                        <p><i>Usuários online no Slack - Junte-se a nós.</i></p>
                        <a href="/slack" target="_blank" class="item" title="Slack">
                            <img src="slack/badge"/>
                        </a>
                    </div>
